...
@property (retain, nonatomic) NSString *libPath;
@property (strong, nonatomic) BizTabViewController *tabBarController;
@property (strong, nonatomic) UINavigationController *bizNa;
@end
